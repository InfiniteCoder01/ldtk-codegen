        ...
        Self {
            ...
            entities_demo: Level {
                ...
                tiles: Tiles {
                    size: Vec2::new(51, 29),
                    tiles: vec! {
                        Some(Tile::new(Vec2::new(8, 0), FlipMode::None)),
                        Some(Tile::new(Vec2::new(9, 0), FlipMode::None)),
                        Some(Tile::new(Vec2::new(8, 0), FlipMode::None)),
                        Some(Tile::new(Vec2::new(9, 0), FlipMode::None)),
                        Some(Tile::new(Vec2::new(8, 0), FlipMode::None)),
                        Some(Tile::new(Vec2::new(9, 0), FlipMode::None)),
                        ...
                        Some(Tile::new(Vec2::new(9, 0), FlipMode::None)),
                        Some(Tile::new(Vec2::new(8, 0), FlipMode::None)),
                        Some(Tile::new(Vec2::new(8, 1), FlipMode::None)),
                        Some(Tile::new(Vec2::new(9, 1), FlipMode::None)),
                        Some(Tile::new(Vec2::new(8, 1), FlipMode::None)),
                        Some(Tile::new(Vec2::new(9, 1), FlipMode::None)),
                        Some(Tile::new(Vec2::new(8, 1), FlipMode::None)),
                        Some(Tile::new(Vec2::new(9, 1), FlipMode::None)),
